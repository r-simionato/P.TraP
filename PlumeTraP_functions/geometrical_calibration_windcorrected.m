%% geometrical_calibration_windcorrected - PlumeTraP
% Function to apply the geometric calbration and the wind correction
% Author: Riccardo Simionato. Date: April 2024
% Structure: PlumeTraP --> geometrical_calibration_windcorrected

function [pixel,wdir] = geometrical_calibration_windcorrected(procframes,...
...
[pixel] = geometrical_calibration(imgplume_height,imgplume_width,par);
