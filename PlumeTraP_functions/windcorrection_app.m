%% windcorrection_app - PlumeTraP
% Function to apply the wind correction if using calibration files with GUI
% Author: Riccardo Simionato. Date: April 2024
% Structure: PlumeTraP --> windcorrection_app

function [pixel,wdir] = windcorrection_app(pixel,procframes,...
    outFolder_proc,imageList_proc,outFolder_parameters,...
    imgplume_height,imgplume_width,par,geopot_nc,wind_nc,roiPos)
